...
export default function PrivacyPolicyPageClient({ lang: langProp }: { lang?: Language } = {}) {
  ...
  const copy = siteContent[lang].privacyPolicy
  const isEs = lang === "es"
        ...
        <div className="mt-16 rounded-[2.5rem] bg-zinc-950 p-8 md:p-12 text-white flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="max-w-md">
            <h2 className="text-2xl font-bold text-white mb-3">
              {isEs ? "¿Tienes dudas sobre tus datos?" : "Have questions about your data?"}
            </h2>
